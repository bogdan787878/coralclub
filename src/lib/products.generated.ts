...
export const GENERATED_PRODUCTS: ProductContent[] = [
  ...
  },
  {
    ...
    "price": "$281.25",
    "clubPrice": "$225",
    "description": "A hyaluronic acid and chondroitin complex developed in Germany — nourishes and restores cartilage tissue, activates the body's own synovial fluid, and eases joint stiffness. One course's benefits last up to 5 months.",
    "carouselImages": [
      "/images/products/bar6cmifim4pgndxjdg81o4qipfeydot.webp"
    ],
    "pdpImages": [
      "/images/products/6lz3zje3xybabziihe259f4ipi6v2o2z.webp"
    ],
    "howToUse": "One measuring cup (30 ml) once a day after a meal.",
    "elements": [
      {
        "symbol": "HA",
        "name": "Hyaluronic"
    ...
    "manufacturing": {
      ...
      "shippingWeight": "",
      "expiration": "2 years from the date of manufacture",
      "storage": "Keep out of reach of children. Protect from heat, light, and moisture. Store in a dry place at no more than +25 °C. Refrigerate after opening.",
      "ingredients": "Vitamin E (as dl-alpha tocopheryl acetate), chondroitin sulfate, hyaluronic acid, other ingredients.",
      "supplementFacts": {
        "servingLabel": "Amount Per Serving",
        "rows": [
          {
  ...
  },
  {
    ...
    "carouselImages": [
      ...
      "/images/products/ChatGPT Image Sep 12, 2026 at 03_15_06 AM.png"
    ],
    "pdpImages": [
      "/images/products/parashield.png",
      "/images/products/ChatGPT Image Sep 12, 2026 at 03_14_14 AM.png"
    ],
    "howToUse": "Add one serving to water and take daily. Full directions coming soon.",
    "elements": [
      {
...
export const GENERATED_DOMAINS: DomainContent[] = [
  ...
  },
  {
    ...
    "products": [
      ...
      "coral-artichoke",
      "fandetox",
      "premium-plankton-oil-new-2025-glass",
      "selenium",
      "slim-by-slim-2374"
    ]
  },
  ...
  },
  {
    ...
    "goal": "sleep",
    "products": [
      "evening-formula-91832",
      "mindset",
      "coral-magnesium",
      "griffonia",
      "phytomix-for-women-new",
      "coral-lecithin",
      "lipostick-fit",
      "oceanmin",
      "coral-mine-silver",
...
export const GENERATED_SERIES: SeriesContent[] = [
  ...
  },
  {
    ...
    "enabled": true,
    "heading": "",
    "titleLead": "Collagen fades with age.",
    "titleAccent": "Marine peptides restore it.",
    "blurb": "Liquid marine collagen, fast to absorb — for glowing skin, stronger hair and nails. Pair with a biocellulose mask for deeper renewal.",
    "product": "",
    "weight": 0,
    "images": [
  ...
  },
  {
    ...
    "blurb": "Plain water moves through you fast — minerals and electrolytes are what make it stay.",
